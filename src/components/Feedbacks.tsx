...
import { testimonials, ITestimonial } from '../constants';

const FeedbackCard = ( feedback : ITestimonial) => {
  return(
    <motion.div 
      ...
      className="bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full">
        ...
        <div className="mt-1">
          <p className="text-white tracking-wider text-[18px]">{feedback.testimonial}</p>
